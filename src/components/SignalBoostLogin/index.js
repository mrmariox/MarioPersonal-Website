...
const SignalBoostPage = data => {
  ...
  return (
    <div>
      ...
      <br /><br />
      <MenuBar />
      <p>[mariog@MarioGeorgiev ~]$ <span className={signalBoostLoginStyles.typed}>&nbsp;useradd<span>&nbsp;</span></span></p>
      <div className={hidden ? signalBoostLoginStyles.hiddenPart : ""}>
        ...
        <p>To add yourself to this list, fork <a href="https://github.com/mrmariox/MarioPersonal-Website" target="_blank" rel="noopener noreferrer">this website's source code</a> and submit a pull request with edits following <a href="https://github.com/mrmariox/MarioPersonal-Website/tree/master/src/signalboost" target="_blank" rel="noopener noreferrer">these instructions</a>.</p>
        <p>With COVID-19 continuing to rage across the world and new world disasters to happen every day, these people are in need of a job now more than ever.</p>
        <hr/><hr/>
        <h2>People</h2>
        <hr/>
